...
1. Clone this repo from `https://github.com/#########/angularjs-gulp-browserify-boilerplate.git`
...
Copied from https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate.git
